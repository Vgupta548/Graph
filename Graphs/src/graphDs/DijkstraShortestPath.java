...
{ 
	...
	{ 
		...
		{ 
			...
			System.out.println("min Distance found : index -> "+u);
			...
			for (int v = 0; v < V; v++) 
				...
				if (!sptSet[v] && graph[u][v]!=0 && 
					...
					if (dist[u]+graph[u][v] < dist[v]) {
						...
						System.out.println("distance ----------------- index  "+v+ " :dist "+dist[v]);
						System.out.println("pathLenth ----------------- of v  "+pathLenth[v]);
					}else if(dist[u]+graph[u][v] == dist[v]) {
						
						if(pathLenth[v] > pathLenth[u]+1) {
							parent[v]= u;
							System.out.println("pathLenth q----------------- of v  "+pathLenth[v]);
							pathLenth[v]= pathLenth[u]+1; 
						}
